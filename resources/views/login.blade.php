            ...
            <div class="card-body">
                ...
                <form action="/login" method="POST" class="mx-auto d-block">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" class="form-control form-brown rounded-10 @error('email') is-invalid @enderror" id="email" autofocus required value="{{ old('email') }}">
                        @error('email')
                    ...
                    <div class="mb-5">
                        ...
                        <input type="password" name="password" class="form-control form-brown rounded-10" id="password" required>
                    </div>
                    <div class="mb-3">
