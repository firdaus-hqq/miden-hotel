        ...
        <- Kembali </a>
            <div class="card card-brown shadow mt-3 mb-5 rounded-20">
                <div class="card-body p-4">
                    <form action="/fasilitas_hotel/{{ $fasilitas_hotel->id }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_fasilitas"
                                ...
                                id="nama_fasilitas" required value="{{ old('nama_fasilitas', $fasilitas_hotel->nama_fasilitas) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="deskripsi" name="deskripsi"
                                ...
                                style="height: 150px" id="deskripsi" required>{{ old('deskripsi', $fasilitas_hotel->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                name="gambar" type="file" id="gambar" value="{{ old('gambar', $fasilitas_hotel->gambar) }}">
                            @error('gambar')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
