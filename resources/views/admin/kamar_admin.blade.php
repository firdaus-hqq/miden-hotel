                ...
                <table class="table table-hover table-responsive form-brown text-form-brown">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="align-middle">Menampilkan ruang 32 meter persegi yang nyaman, berfungsi sebagai tipe kamar yang sempurna untuk tamu yang ingin menikmati keseimbangan sempurna antara akomodasi berkualitas tinggi dan penawaran bernilai tinggi selama kunjungan mereka di kota ini</td>
